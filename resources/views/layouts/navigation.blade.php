<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Responsive Singers -->
            <x-responsive-nav-link :href="route('admin.singers.index')" :active="request()->routeIs('admin.singers.*')">
                {{ __('Singers') }}
            </x-responsive-nav-link>
            ...
            <!-- Responsive Songs -->
            <x-responsive-nav-link :href="route('admin.songs.index')" :active="request()->routeIs('admin.albums.songs.*')">
                {{ __('Songs') }}
            </x-responsive-nav-link>
        </div>
