<!-- resources/views/admin/songs/edit.blade.php -->
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div class="md:col-span-2">
                <div class="space-y-4">
                    ...
                    <!-- Arquivo de Áudio -->
                    <div>
                        <label for="song_file" class="block mb-2 font-medium text-gray-300">Arquivo de Áudio (Atual)</label>
                        ...
                        <label for="new_song_file" class="block mt-4 mb-2 font-medium text-gray-300">Substituir Arquivo</label>
                        <input type="file" id="new_song_file" name="song_file" accept=".mp3,.wav,.aac"
                            class="w-full p-2 text-white bg-gray-800 border border-gray-700 rounded focus:border-blue-500 focus:outline-none">
            ...
            <div class="space-y-4">
                <div class="p-4 bg-gray-800 rounded-lg">
                    <h3 class="mb-2 font-medium text-gray-300">Informações do Álbum</h3>
                ...
                <div class="flex flex-col gap-3">
                    <button type="submit"
                        class="w-full px-4 py-4 text-white transition duration-300 bg-blue-600 rounded hover:bg-blue-700">
                        Atualizar Música
                    </button>
                    <a href="{{ route('admin.songs.index', $album->id) }}"
                        class="w-full px-4 py-5 text-center text-white transition duration-300 bg-gray-600 rounded hover:bg-gray-700">
                        Cancelar
                    </a>
                </div>
            </div>
